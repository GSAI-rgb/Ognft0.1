...
def analyze_uploaded_assets():
    ...
    for design in tee_designs:
        ...
        for color in design["colors"]:
            back_img = f"https://shopify-debugger.preview.emergentagent.com/products/teeshirt/{design['name']}/{color}/back.jpg"
            front_img = f"https://shopify-debugger.preview.emergentagent.com/products/teeshirt/{design['name']}/{color}/front.jpg"
            images.extend([back_img, front_img])
        
        # If no colors specified, use standard structure - BACK FIRST
        if not design["colors"]:
            back_img = f"https://shopify-debugger.preview.emergentagent.com/products/teeshirt/{design['name']}/back/main.jpg"
            front_img = f"https://shopify-debugger.preview.emergentagent.com/products/teeshirt/{design['name']}/front/main.jpg"
        ...
        product = {
            ...
            "primaryImage": images[0] if images else f"https://shopify-debugger.preview.emergentagent.com/products/teeshirt/{design['name']}/back/main.jpg",  # ALWAYS BACK IMAGE
            ...
            "colorVariants": [
                {
                    "color": color,
                    "backImage": f"https://shopify-debugger.preview.emergentagent.com/products/teeshirt/{design['name']}/{color}/back.jpg",
                    "frontImage": f"https://shopify-debugger.preview.emergentagent.com/products/teeshirt/{design['name']}/{color}/front.jpg"
                } for color in design["colors"]
            ]
        }
    ...
    for hoodie in hoodie_designs:
        ...
        back_image = f"https://shopify-debugger.preview.emergentagent.com/products/hoodies/{hoodie['name'].replace(' ', '_')}/back/main.jpg"
        front_image = f"https://shopify-debugger.preview.emergentagent.com/products/hoodies/{hoodie['name'].replace(' ', '_')}/front/main.jpg"
        side_image = f"https://shopify-debugger.preview.emergentagent.com/products/hoodies/{hoodie['name'].replace(' ', '_')}/side/main.jpg"
    ...
    for poster in poster_designs:
        poster_image = f"https://shopify-debugger.preview.emergentagent.com/products/posters/{poster['name'].replace(' ', '_')}/main.jpg"
